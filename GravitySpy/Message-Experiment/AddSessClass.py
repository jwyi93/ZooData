...
raw_data = pd.read_csv('Gs_Class_Message_20161206-no-duplicate.csv') # CHANGE NAME OF .CSV FILE
# Rename columns 
...
# Export dataframe
raw_data.to_csv('Gs_Class_Message_20161206-no-duplicate-SessClass.csv') #Change File name to project name. 
